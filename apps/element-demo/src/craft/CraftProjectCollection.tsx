...
import ProjectCollection, { ProjectCollectionProps } from '@lodestar/ui/components/collections/ProjectCollection'
import Craftize, { PropsWithCraft } from '@lodestar/ui/components/common/Craftize'
import { ProjectCollectionSource, useProjectCollection } from '@lodestar/data-hasura/hooks/projectCollection'
...
const ConnectedProjectCollection: React.FC<CraftProjectCollectionProps> = ({ source, type, ...rest }) => {
  ...
  const resolvedSource = useMemo<ProjectCollectionSource>(() => source ?? DEFAULT_SOURCE, [source])
...
export const CraftProjectCollection: UserComponent<PropsWithCraft<CraftProjectCollectionProps>> =
